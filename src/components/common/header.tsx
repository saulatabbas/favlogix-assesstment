...
const Header = ({ selectedPolygon, handlePolygonClick, handlePreview }: { selectedPolygon?: string, handlePolygonClick: () => void, handlePreview: () => void }) => {
  ...
  return (
    <>
      <nav className="bg-white shadow-sm border-b-2 border-gray-300   relative lg:border-0 rounded-xl flex justify-between items-center px-4 lg:px-[1%] py-2 lg:py-[0.8%] ">
        ...
        <button
          onClick={handlePreview}
          className="
      absolute top-[-74%] md:top-[-3.5%] left-1/2 -translate-x-1/2
      z-3000  lg:hidden
